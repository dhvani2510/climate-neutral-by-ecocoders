const individualSavingsBtn = document.querySelector('.action-savings button:nth-of-type(1)');
const overallSavingsBtn = document.querySelector('.action-savings button:nth-of-type(2)');
